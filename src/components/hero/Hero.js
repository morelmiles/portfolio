    ...
    <div className="row hero__container">
      ...
      <div className="col-md-6 hero__text">
        ...
        <p className="hero__para">
          Sed mauris congue et ut sit scelerisque tristique ultricies ac viverra
          aliquet eget non auctor aenean vitae, lacus turpis cursus quis
          venenatis mollis phasellus faucibus velit, orci integer blandit nisl
          habitant proin habitant v olutpat mauris, neque, et, lectus in mi
        </p>
        <div className="mx-4">
